...
///////////// <<<<<<
  ...
  //
  // ADD, REMOVE COLLECTION ADMIN - what is collection "admin"
  //
  ...
  //
  // TRANSFER, TRANSFERFROM - what is transferfrom?
  //
  ...
  //
  // MINT MULTIPLE TOKENS, ONE OWNER
  //
  ...
  //
  // GET COLLECTION TOKENS BY ADDRESS  <<<<<<<<<<
  //
