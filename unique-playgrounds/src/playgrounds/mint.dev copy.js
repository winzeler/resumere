...
const main = async (args) => {
  ...
  let collection = {
    ...
    tokenPropertyPermissions: [{key: 'name', permission: {mutable: false, collectionAdmin: true, tokenOwner: false}}, 
                               ...
                               //{key: 'offchainSchema', permission: {mutable: false, collectionAdmin: true, tokenOwner: false}}],
    limits: {
  ...
  // set schema version
//  let res, info;
//  res = await uniqueHelper.setOffchainSchema(alice, collectionId, 'https://avatars.githubusercontent.com/u/7943272?s=200&v=4&id={id}');
//  info = await uniqueHelper.getCollection(collectionId);
  ...
  const result = await uniqueHelper.mintNFTToken(alice, {collectionId, owner: alice.address, properties: [{key: 'name', value: 'Bryan Foreman7'},
                              //{key: 'SchemaVersion', value: 'ImageURL'},
                              //{key: 'OffchainSchema', value: 'https://avatars.githubusercontent.com/u/7943272?s=200&v=4'}
                              //{key: 'metadata', value: 'https://raw.githubusercontent.com/jsonresume/jsonresume-gpt3/master/resumes/Bryan-Foreman.json'}, 
